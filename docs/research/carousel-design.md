...
|----------|---------|-------|
| **Aspect ratio** | 1:1 (1080×1080), 4:5 (1080×1350), 16:9 (1920×1080) | 4:5 maximizes mobile screen real estate [VERIFIED] |
...
| Variable | Options | Source |
|----------|---------|--------|
| **Grid system** | Rule of Thirds (3×3), Modular (4×4, 6×6), Golden Ratio, Asymmetric | Composition fundamentals [VERIFIED] |
...
**Maximum (programmatic):** 60+ independent design axes across color (6), typography (8), layout (5), slide structure (6 patterns), visual elements (7 categories × 4+ options each), brand positioning (6), plus per-slide content variables.

**Combinatorial space** (conservative): 6 palettes × 4 type scales × 3 grids × 6 structures × 4 whitespace × 5 icon styles × 4 CTA styles × 5 logo positions = **~86,400 unique combinations** from just 8 axes.
