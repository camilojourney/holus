...
- **READ:** Finalized LinkedIn post text, `agentic/memory/knowledge/current/platforms.md` (per-platform algorithm signals, adaptation rules, character limits, cadence), `config/brand.yaml` (voice, anti-patterns, platform_strategy)
