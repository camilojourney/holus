...
- **READ:** The full content piece (text), `config/brand.yaml` voice section and anti_patterns, `agentic/memory/knowledge/current/viral-frameworks.md` (hook frameworks + engagement data), `agentic/memory/knowledge/current/voice-profile.md` (structural patterns)
