...
- **READ:** content topic + product angle, `config/brand.yaml` (voice, anti-patterns, positioning), `.self-improvement/knowledge/current/content-formats.md` (TikTok/video templates, platform rules)
