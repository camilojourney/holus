...
- **READ:** `config/brand.yaml` (voice.hooks, anti_patterns), `.self-improvement/knowledge/current/viral-frameworks.md` (all 12 hook frameworks with engagement data), `.self-improvement/knowledge/current/voice-profile.md` (structural patterns, opening hooks table)
