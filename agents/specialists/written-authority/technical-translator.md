...
- **READ:** Product docs or technical context provided in the content brief (architecture docs, feature descriptions, implementation details from `ARCHITECTURE.md` or silo READMEs), `.self-improvement/knowledge/current/voice-profile.md` (credibility anchors, formula device, technical-but-accessible tone markers)
